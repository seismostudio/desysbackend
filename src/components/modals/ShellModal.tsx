import type { Shell, Joint, ShellSection, AreaLoad, LoadPattern } from '../../types/structuralTypes';
...
export function ShellModal({ shell, joints, sections, onUpdate, onDelete, onClose, loadPatterns, areaLoads, onAddLoad, onDeleteLoad }: ShellModalProps) {
    ...
    const shellLoads = areaLoads.filter(l => l.shellId === shell.id);
                ...
                <div className="p-4 space-y-5">
                    ...
                    <section className="border-t border-gray-600 pt-4">
                        ...
                        <div className="bg-gray-800/50 p-3 rounded-lg border border-gray-700 mb-4">
                            <h5 className="text-[10px] font-bold text-gray-300 mb-2 uppercase">Add Area Load</h5>
                        ...
                        <div className="space-y-2">
                            {shellLoads.length > 0 ? (
                                ...
                                <div className="text-center text-gray-500 text-[10px] italic py-2">No loads assigned to this shell</div>
                            )}
                        </div>
                    </section>
                </div>
