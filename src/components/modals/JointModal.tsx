        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-200">
                <div className="flex items-center justify-between px-4 py-3 border-b bg-gray-50">
                    <h3 className="font-bold text-gray-800">Joint Details - ID: {joint.id}</h3>
                ...
                <div className="p-4 space-y-4">
                    <section>
                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Coordinates (m)</h4>
                    ...
                    <section>
                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Restraints</h4>
                        <div className="grid grid-cols-3 gap-y-3 gap-x-4">
                            {(['ux', 'uy', 'uz', 'rx', 'ry', 'rz'] as const).map((r) => (
                                <label key={r} className="flex items-center gap-2 cursor-pointer group">
                                    ...
                                    <span className="text-sm text-gray-700 group-hover:text-blue-600 transition-colors uppercase">
                                        {r}
                                    </span>
                                </label>
                            ))}
